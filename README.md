...
gcloud compute firewall-rules create allow-http --direction=INGRESS --priority=1000 --network=default --action=ALLOW 
...
#Use the arrow keys to move the cursor to the line below the h1 header. Add text like this "Hi from Hazem" then save & exit.
